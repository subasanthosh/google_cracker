...
export default function WeeklySystemSection() {
  return (
    <section className="weekly-system-section" id="weekly-system" style={{ backgroundImage: `linear-gradient(rgba(3, 5, 9, 0.5), rgba(3, 5, 9, 0.75)), url(${bgImage2})`, backgroundSize: 'cover', backgroundAttachment: 'fixed', padding: '6rem 0' }}>
